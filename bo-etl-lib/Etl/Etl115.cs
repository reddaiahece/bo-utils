...
using GenericInfoObject = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.GenericInfoObject;
using User = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.User;
using UserGroup = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.UserGroup;
using Category = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Category;
using PersonalCategory = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.PersonalCategory;
...
using Universe = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Universe;
using Connection = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Connection;
...
using CollateralId = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CollateralId;
...
//using CustomRelation = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomRelation;
using CustomPropertiesDouble = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesDouble;
using CustomPropertiesString = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesString;
using CustomPropertiesBool = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesBool;
using CustomPropertiesDate = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesDate;
using CustomPropertiesInteger = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesInteger;
using GetOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.GetOptions;
using FullClientDataProvider = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FullClientDataProvider;
using SecurityInfo = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.SecurityInfo;
//using SecurityInfo2 = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.SecurityInfo2;
using Principal = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Principal;
using RoleEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.RoleEnum;
//using CustomRole = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomRole;
//using Role = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Role;
using Right = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Right;
using RightInfo = DSWS115::BusinessObjects.DSWS.BIPlatform.RightInfo;
using Profile = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Profile;
using Inbox = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Inbox;
using SystemRightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.SystemRightEnum;
using Designer_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.Designer_RightEnum;
using InfoView_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.InfoView_RightEnum;
//using Event_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.Event_RightEnum;
using CrystalReport_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.CrystalReport_RightEnum;
//using BIWidgets_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.BIWidgets_RightEnum;
using Universe_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.Universe_RightEnum;
using Webi_RightEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Rights.Webi_RightEnum;
//using RoleRight = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.RoleRight;
...
using Word = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Word;
using Powerpoint = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Powerpoint;
using Destination = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Destination;
using DestinationScheduleOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.DestinationScheduleOptions;
...
using FtpScheduleOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.FtpScheduleOptions;
using SMTPScheduleOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.SMTPScheduleOptions;
using MetaDataDataConnection = DSWS115::BusinessObjects.DSWS.BIPlatform.Metadata.MetaDataDataConnection;
...
{
    public class Etl115 : Session115{

        IDataBase[] databases;
        //int principalId = 0;
        int rightId = 0;

        public Etl115(string sessionURL) : base(sessionURL) { }
...
/*
   ...
   */   
        ...
        public bool GetInstances(){
            ...
            string[] kind = new string[] { "Pdf","Excel","Webi","CrystalReport","FullClient","Powerpoint","Word","ObjectPackage","Publication" }; // 'Txt'
            for(int i=0;i<kind.Length;i++){
        ...
        public void GetSecurity(ref List<InfoObject> lstObjects, ref List<PRINCIPALE> lstPrincipales, ref List<PRINCIPALRIGHT> lstRights, ref List<PRINCIPALROLE> lstRoles){
            foreach(InfoObject infoObject in lstObjects){
                if (infoObject.SecurityInfo != null && infoObject.SecurityInfo.Principal!=null){
                    foreach(Principal principal in infoObject.SecurityInfo.Principal){
        ...
        public object getGenericInfoObject(CustomProperties customProperties, string nameID, int startPos=0, int endPos=0){
            ...
            for(int i=startPos; i<=endPos; i++ ){
                ...
                if(nameID==null && item is CustomProperties ){
                    return ((CustomProperties)item).Items;
