...
using GenericInfoObject = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.GenericInfoObject;
using User = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.User;
using UserGroup = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.UserGroup;
using Category = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Category;
using PersonalCategory = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.PersonalCategory;
...
using Universe = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Universe;
using Connection = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Connection;
...
using CollateralId = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CollateralId;
...
using CustomRelation = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomRelation;
using CustomPropertiesDouble = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesDouble;
using CustomPropertiesString = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesString;
using CustomPropertiesBool = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesBool;
using CustomPropertiesDate = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesDate;
using CustomPropertiesInteger = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesInteger;
using GetOptions = DSWS120::BusinessObjects.DSWS.BIPlatform.GetOptions;
using FullClientDataProvider = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.FullClientDataProvider;
using SecurityInfo = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.SecurityInfo;
using SecurityInfo2 = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.SecurityInfo2;
using Principal = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Principal;
using RoleEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.RoleEnum;
using CustomRole = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.CustomRole;
using Role = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Role;
using Right = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Right;
using RightInfo = DSWS120::BusinessObjects.DSWS.BIPlatform.RightInfo;
using Profile = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Profile;
using Inbox = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Inbox;
using SystemRightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.SystemRightEnum;
using Designer_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.Designer_RightEnum;
using InfoView_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.InfoView_RightEnum;
//using Event_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.Event_RightEnum;
using CrystalReport_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.CrystalReport_RightEnum;
using BIWidgets_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.BIWidgets_RightEnum;
using Universe_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.Universe_RightEnum;
using Webi_RightEnum = DSWS120::BusinessObjects.DSWS.BIPlatform.Rights.Webi_RightEnum;
using RoleRight = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.RoleRight;
...
using Word = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Word;
using Powerpoint = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Powerpoint;
using Destination = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.Destination;
using DestinationScheduleOptions = DSWS120::BusinessObjects.DSWS.BIPlatform.Desktop.DestinationScheduleOptions;
...
using FtpScheduleOptions = DSWS120::BusinessObjects.DSWS.BIPlatform.Dest.FtpScheduleOptions;
using SMTPScheduleOptions = DSWS120::BusinessObjects.DSWS.BIPlatform.Dest.SMTPScheduleOptions;
using MetaDataDataConnection = DSWS120::BusinessObjects.DSWS.BIPlatform.Metadata.MetaDataDataConnection;
...
{
    public class Etl120 : Session120{

        IDataBase[] databases;
        //int principalId = 0;
        int rightId = 0;

        public Etl120(string sessionURL) : base(sessionURL) { }
