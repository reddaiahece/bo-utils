...
using Connection = DSWS120::BusinessObjects.DSWS.Connection;
using Session = DSWS120::BusinessObjects.DSWS.Session.Session;
using SessionInfo = DSWS120::BusinessObjects.DSWS.Session.SessionInfo;
using EnterpriseCredential = DSWS120::BusinessObjects.DSWS.Session.EnterpriseCredential;
using BIPlatform = DSWS120::BusinessObjects.DSWS.BIPlatform.BIPlatform;
using DSWSException = DSWS120::BusinessObjects.DSWS.DSWSException;
using WSResource = DSWS120::BusinessObjects.DSWS.Session.WSResource;

namespace BusinessObjectsEtl
{
    public class Session120 : SessionBase
    {
        ...
        public Session120( string sessionURL) : base(sessionURL){
