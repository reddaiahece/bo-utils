...
using FixedCUIDs = DSWS115::BusinessObjects.DSWS.BIPlatform.Constants.FixedCUIDs;
using ResponseHolder = DSWS115::BusinessObjects.DSWS.BIPlatform.ResponseHolder;
using InfoObjects = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.InfoObjects;
using InfoObject = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.InfoObject;
using PageInfo = DSWS115::BusinessObjects.DSWS.BIPlatform.PageInfo;
using PagingDetails = DSWS115::BusinessObjects.DSWS.BIPlatform.PagingDetails;
using DownloadStatus = DSWS115::BusinessObjects.DSWS.BIPlatform.DownloadStatus;
using PromptValue = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.PromptValue;
using PromptValueR = DSWS115::BusinessObjects.DSWS.ReportEngine.PromptValue;
using DiscretePromptValue = DSWS115::BusinessObjects.DSWS.ReportEngine.DiscretePromptValue;
using RangePromptValue = DSWS115::BusinessObjects.DSWS.ReportEngine.RangePromptValue;
using DiskUnmanaged = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.DiskUnmanaged;
using DiskUnmanagedScheduleOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.DiskUnmanagedScheduleOptions;
using SMTPScheduleOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.SMTPScheduleOptions;
using ManagedScheduleOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.ManagedScheduleOptions;
using GetOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.GetOptions;
using RetrievePromptsInfo = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrievePromptsInfo;
using RetrieveReportList = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveReportList;
using Action = DSWS115::BusinessObjects.DSWS.ReportEngine.Action;
using Close = DSWS115::BusinessObjects.DSWS.ReportEngine.Close;
using PromptInfo = DSWS115::BusinessObjects.DSWS.ReportEngine.PromptInfo;
using DocumentInformation = DSWS115::BusinessObjects.DSWS.ReportEngine.DocumentInformation;
using RetrieveMustFillInfo = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveMustFillInfo;
using RetrieveViewSupport = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveViewSupport;
using Report_ = DSWS115::BusinessObjects.DSWS.ReportEngine.Report;
using XMLView = DSWS115::BusinessObjects.DSWS.ReportEngine.XMLView;
using CharacterView = DSWS115::BusinessObjects.DSWS.ReportEngine.CharacterView;
using RetrieveData = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveData;
using RetrieveView = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveView;
using OutputFormatType = DSWS115::BusinessObjects.DSWS.ReportEngine.OutputFormatType;
using ViewModeType = DSWS115::BusinessObjects.DSWS.ReportEngine.ViewModeType;
using NavigateToPath = DSWS115::BusinessObjects.DSWS.ReportEngine.NavigateToPath;
using ViewType = DSWS115::BusinessObjects.DSWS.ReportEngine.ViewType;
using ViewSupport = DSWS115::BusinessObjects.DSWS.ReportEngine.ViewSupport;
using RetrieveXMLView = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveXMLView;
using RetrieveBinaryView = DSWS115::BusinessObjects.DSWS.ReportEngine.RetrieveBinaryView;
using BinaryView = DSWS115::BusinessObjects.DSWS.ReportEngine.BinaryView;
using Folder = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Folder;
using Inbox = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Inbox;
using FavoritesFolder = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FavoritesFolder;
using PathFolder = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.PathFolder;
using Pdf = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Pdf;
using Excel = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Excel;
using Webi = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Webi;
using WebiPrompt = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.WebiPrompt;
using WebiFormatEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.WebiFormatEnum;
using WebiFormatOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.WebiFormatOptions;
using WebiProcessingInfo = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.WebiProcessingInfo;
using CrystalReport = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CrystalReport;
using CrystalReportFormatOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CrystalReportFormatOptions;
using DataProvider = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.DataProvider;
using ScheduleTypeEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.ScheduleTypeEnum;
using SchedulingInfo = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.SchedulingInfo;
using ReportFormatEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.ReportFormatEnum;
using Destination = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Destination;
using Program = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Program;
using SMTP = DSWS115::BusinessObjects.DSWS.BIPlatform.Dest.SMTP;
using Notifications = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Notifications;
using ReportParameter = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.ReportParameter;
using DeletionCriteria = DSWS115::BusinessObjects.DSWS.BIPlatform.DeletionCriteria;
using Publication = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Publication;
using FormatTypeEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FormatTypeEnum;
using OutputFormat = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.OutputFormat;
using ScheduleStatusEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.ScheduleStatusEnum;
using ScheduleOutcomeEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.ScheduleOutcomeEnum;
using File = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.File;
using Path = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.Path;
using FileProperties = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FileProperties;
using CustomProperties = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomProperties;
using CustomPropertiesString = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.CustomPropertiesString;
using FullClient = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FullClient;
using FullClientProcessingInfo = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FullClientProcessingInfo;
using FullClientPrompt = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FullClientPrompt;
using FullClientFormatOptions = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FullClientFormatOptions;
using FullClientFormatEnum = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.FullClientFormatEnum;
using ObjectPackage = DSWS115::BusinessObjects.DSWS.BIPlatform.Desktop.ObjectPackage;
using BusinessObjectsUtils.bo_session;

namespace BusinessObjectsUtils.bo_scheduler.dsws
{
	public class Scheduler115 : IScheduler
	{
        ...
        public Scheduler115(SessionManager sessionmanager)
        {
            if (!(sessionmanager.Session is Session115)) throw new Exception("Wrong version between session and scheduler!");
            _sessionmanager = sessionmanager;
            _biplatform = (sessionmanager.Session as Session115).BIPlatform;
            _reportengine = (sessionmanager.Session as Session115).ReportEngine;
        }
        ...
        public ExitCode GetReports(string pPath, bool pWithPrompts, string pAssociatedInstance, out Report[] pReports){
            ...
            const string @where = "SI_KIND IN('Webi','FullClient','CrystalReport') AND SI_INSTANCE=0";
                            ...
                            if(boInfoObjectPrompts is Pdf){
                                ...
                                if(pWithPrompts && reportCrystal.PluginProcessingInterface!=null 
								    ...
								    for (var i = 0; i < reportParam.Length; i++){
									    var values = string.Empty;
                                        if (reportParam[i].CurrentValues != null){
									        foreach( var val in reportParam[i].CurrentValues){
                                                if (values != string.Empty) values += ";";
										        values += val.Data;
									        }
                            ...
                            if(pSetPrompts && reportCrystal.PluginProcessingInterface.ReportParameters != null){
                                ...
                                if(reportParam.Length !=0){
						            ...
						            for(var cp = 0; cp < reportParam.Length; cp++){
                                        reportParam[cp].CurrentValues = null;
                                        foreach(var prompt in report.Prompts){
                                            ...
                                            reportParam[cp].CurrentValues = new PromptValue[myPrompts.Length];
                                            for(var v = 0; v < myPrompts.Length; v++)
                                                reportParam[cp].CurrentValues[v] = new PromptValue { Data = myPrompts[v] };
                                            break;
                                        }
